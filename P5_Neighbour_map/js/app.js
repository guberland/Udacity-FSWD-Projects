...
var locations = [
    {name: 'Iona Beach', geoLocation: {lat: 49.21658795, lng: -123.21218491}, description: "Located just north of Vancouver International Airport, Iona Beach Regional Park is a unique area of land made up of a long, narrow jetty of sand and grass along the mouth of the Fraser River."},
...
function populateInfoWindow(marker, infowindow) {
    ...
    if (infowindow.marker != marker) {
        var url = "https://api.flickr.com/services/rest/?method=flickr.photos"
                  +".search&api_key=de5e8d74b7c261bce18d9b92acff771d&tags="+marker.name;
        var src;

//error function when ajax call fails
...
//function that does ajax request from flickr to fill the Info Window with i(2) pictures
        ...
        infowindow.setContent('<div class="title">' + marker.name + '</div><hr>' + '<p>'
                              + marker.content + '</p>' + '<div id="images" ></div><hr>');
